...
const AddJobs = () => {
    ...
    const handleNextButtonClickcase1 = async (values) => {
        ...
        let job = await JSON.parse(getStorage("postjob"));
        if (job === null) {
            job = {};
        }
        job.jobTitle = values.jobTitle;
                        ...
                        <div className="md:w-full bg-white lg:px-3">
                            <Formik
                                initialValues={{
                                    ...
                                    location: selectedCity ? `${selectedCity.name}, ${selectedCity.country}` : "",
                                    jobType: job ? job.jobType : "",
                                    jobLocation: job ? job.jobLocation : "",
                                    reqApp: job ? job.reqApp : "",
                                    validTill: job ? job.validTill : "",
                                    hiringOrganization: job ? job.hiringOrganization : user && user.firstName ? user.firstName : "",
                                }}
                            >
                                    ...
                                    return (
                                        <div className="w-full mt-9">
                                            <Form className="w-fit mt-5">
                                                ...
                                                {values.jobTitle && desc && selectedCity !== null && values.jobType &&
                                                    values.jobLocation && values.validTill && values.hiringOrganization ? (
                                                    <>
                                                        <button
                                                            className="bg-[#228276] px-4 py-2 text-white mx-auto block my-6 rounded-sm"
                                                    ...
                                                    >
                                                        <div className="">
                                                            <div className="w-full">
                                                                {showRoles &&
                                                                    showRoles.filter(role => typeof role === 'string' && role.trim() !== '').map((el, index) => {
                                                                        return (
                                                                            <div key={index}>
                                                                                <Disclosure>
                                                                                    {({ open }) => (
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                />
                                                                                                <span className="mx-3 flex items-center text-base">{el}</span>
                                                                                                {selected[index] &&
                                                                                                                                ...
                                                                                                                                <div className="flex items-center space-x-2 primary-skill-slider ml-auto">
                                                                                                                                    <StarRating
                                                                                                                                        ...
                                                                                                                                        onChange={async (e) => {
                                                                                                                                            ...
                                                                                                                                            setProf(p);
                                                                                                                                            await ls.set("prof", JSON.stringify(p));
                                                                                                                                            await setProf([...p]);
                                                                                                                                            await setDbSkills([...d]);
                                                                                                                                            if (e.target.value > 0) {
                                                                                                                                                let u = user;
        ...
        <div className="flex bg-white rounded-xl w-100">
            <nav className="col pt-5 px-10 flex mb-3 w-1/4">
                <ol class="items-center w-full ">
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 1 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 1 ? "bg-gray-500 text-white" : (PageIndex <= 1 ? "bg-white text-dark shadow-xl" : "bg-green-500 text-white")}`}>
                            1
                        </span>
                        <span>
                    ...
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 2 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 2 ? "bg-gray-500 text-white" : (PageIndex <= 2 ? "bg-white text-dark shadow-xl" : "bg-green-500 text-white")}`}>
                            2
                        </span>
                        <span>
                    ...
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 3 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 3 ? "bg-gray-500 text-white" : (PageIndex <= 3 ? "bg-white text-dark shadow-xl" : "bg-green-500 text-white")}`}>
                            3
                        </span>
                        <span>
                    ...
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 4 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 4 ? "bg-gray-500 text-white" : (PageIndex <= 4 ? "bg-white text-dark shadow-xl " : "bg-green-500 text-white")}`}>
                            4
                        </span>
                        <span>
                    ...
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 5 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 5 ? "bg-gray-500 text-white" : (PageIndex <= 5 ? "bg-white text-dark shadow-xl " : "bg-green-500 text-white")}`}>
                            5
                        </span>
                        <span>
                    ...
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 6 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 6 ? "bg-gray-500 text-white" : (PageIndex <= 6 ? "bg-white text-dark shadow-xl" : "bg-green-500 text-white")}`}>
                            6
                        </span>
                        <span>
                            <h3 class="font-medium leading-tight">Remuneration & pay range</h3>
                            <p class="text-sm">Define remuneration & pay range</p>
                        </span>
                    </li>
                    <li className={`flex items-center space-x-2.5 mb-4 ${PageIndex <= 7 ? "font-medium  dark:text-gray-500" : "font-normal  dark:text-green-500"}`}>
                        <span className={`flex items-center justify-center w-8 h-8 border rounded-full shrink-0 page-index ${PageIndex === 7 ? "bg-gray-500 text-white" : (PageIndex <= 7 ? "bg-white text-dark shadow-xl" : "bg-green-500 text-white")}`}>
                            7
                        </span>
                        <span>
            ...
            <div
                class="h-full min-h-[80em] w-px self-stretch bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-50 dark:opacity-20"></div>
